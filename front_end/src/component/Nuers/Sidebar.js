...
export default function Sidebar({ isCollapsed, closeMenu }) {
  ...
  const navItems = [
    { title: "Home", icon: Home, href: "/DashbordNuers" },
    { title: "Send a Report", icon: Send, href: "/SendReport" },
    { title: "List of Deliveries", icon: ClipboardList, href: "/ListDeliveries" },
    { title: "Giving advice", icon: ClipboardList, href: "/TakeConsultation" },
